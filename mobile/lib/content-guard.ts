 ...
 *
 * Copia de `src/lib/content-guard.ts` (web), donde vive el test. Aquí solo se
 * usa para avisar en pantalla antes de llamar a la API: la frontera de verdad
 * es el `.validator()` del servidor, que corre igual para los dos clientes.
 */
