import { exerciseTotals, pendingExerciseKcal, type DayExercise } from "./exercise";
import { pendingSwapKcal, type MealChange, type MealHabit } from "./plan-shared";
import { pendingSnackKcal, snackTotals, type DaySnacks } from "./snacks";
 ...
 * (`day-balance.test.ts`); copia de `src/lib/day-balance.ts`.
 *
