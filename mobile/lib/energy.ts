 ...
 * Copia de `src/lib/nutrition/energy.ts` de la web (no hay código compartido).
 */

import { ageFromDOB } from "./age";
import { deriveGoalType, normalizeGoalType } from "./daily";
import { effectiveMealSlots, type MealSlot } from "./plan-shared";
