...
// Copia de src/lib/quotes.ts de la web (ver AGENTS.md): la frase del día debe
// coincidir con la de la web para el mismo día.
export const QUOTES: Quote[] = [
  { text: "El que tiene un porqué para vivir puede soportar casi cualquier cómo.", author: "Nietzsche" },
  ...
  { text: "No es el más fuerte el que sobrevive, sino el que mejor se adapta al cambio.", author: "Charles Darwin" },
  ...
  { text: "Ninguno de nosotros, actuando solo, puede alcanzar el éxito.", author: "Nelson Mandela" },
  ...
  { text: "Un río se abre camino a través de las rocas no por su fuerza, sino por su persistencia.", author: "Jim Watkins" },
  ...
  { text: "La grandeza no se mide por lo que tienes, sino por lo que superas.", author: "Booker T. Washington" },
  ...
  { text: "Quien tiene salud tiene esperanza, y quien tiene esperanza lo tiene todo.", author: "Thomas Carlyle" },
];
