  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-lg font-semibold text-foreground">Página no encontrada</h2>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Peppers — Tu asistente de alimentación con IA" },
      {
        name: "description",
        content:
          "Peppers te ayuda a comer mejor cada día: guía diaria, repaso nocturno y progreso visual hacia tu objetivo. Claro, cercano y con sentido común.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,500;0,9..144,600;0,9..144,700;1,9..144,500&family=Work+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Outfit:wght@400;500;600&family=Figtree:wght@400;500;600&family=DM+Mono:wght@400;500&display=swap",
      },
